...
f:{t:"लिंक्स और संपर्क",tag:"स्थिर फीड के लिए प्रीमियम साइलेज।",call:"कॉल: +91 97270 07431",mail:"ईमेल: harshilbarot667@gmail.com",h:"सोम-शनि, 6:00 – 8:00 PM",c:"© 2026 SilageDirect."}},
...
document.getElementById("f-submit").onclick=()=>{
  ...
  const waMsg=encodeURIComponent(`New Enquiry – SilageDirect\nName: ${name}\nPhone: ${phone}\nVillage: ${village||"—"}\nBales: ${bales||"—"}\nBale Type: ${type||"—"}\nNote: ${msg||"—"}`);
